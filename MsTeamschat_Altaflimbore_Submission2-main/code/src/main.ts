type FunctionFactoryType = 'handleMSTeamsImport';

interface FunctionFactory {
    handleMSTeamsImport: (request: Request) => Promise<Response>;
}
...
export const functionFactory: FunctionFactory = {
    handleMSTeamsImport: async (request: Request): Promise<Response> => {
        try {
